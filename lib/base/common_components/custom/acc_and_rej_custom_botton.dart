...
class CustomAcceptAndRejectButton extends StatelessWidget {
  ...
  const CustomAcceptAndRejectButton({Key? key, this.rejectText, this.acceptText, this.acceptIcon, this.rejectIcon, this.acceptLoading, this.rejectLoading, this.onRejectTap, this.onAcceptTap}) : super(key: key);
    ...
    return Row(
      children: [
        Expanded(child: GestureDetector(
          onTap: rejectLoading == true ? null : onRejectTap,
          child: Container(
        ...
        Expanded(child: InkWell(
          onTap: acceptLoading == true ? null : onAcceptTap,
          child: Container(
            padding: EdgeInsets.symmetric(vertical: 17.sp),
            decoration: BoxDecoration(
              color: kPrimaryColor,
