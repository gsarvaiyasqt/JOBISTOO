...
class CustomAcceptAndRejectButton extends StatelessWidget {
  ...
  const CustomAcceptAndRejectButton({Key? key, this.rejectText, this.acceptText, this.acceptIcon, this.rejectIcon, this.acceptLoading, this.rejectLoading}) : super(key: key);
