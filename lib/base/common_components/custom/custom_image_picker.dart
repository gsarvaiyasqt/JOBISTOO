              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: Text("Upload Photo",style: CustomTextStyle.blackSemiBoldFont16Style.copyWith(fontSize: 18.sp))),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text("Gallery",style: CustomTextStyle.blackSemiBoldFont16Style.copyWith(fontSize: 18.sp))
                                    ],
                                  ),
                                ),
                              ),
                                 ...
                                 child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text("Camera",style: CustomTextStyle.blackSemiBoldFont16Style.copyWith(fontSize: 18.sp))
                                    ],
                                  ),
                                ),
                              ),
