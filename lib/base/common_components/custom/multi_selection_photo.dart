        ...
        Row(
          children: [
            Align(
                ...
                child: Text("${widget.headerText}",style: CustomTextStyle.lightFont18Style.copyWith(fontSize: 16.sp))
            ),
            ...
            Padding(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: SvgPicture.asset("$iconPath/add.svg",color: kSecondaryColor),
                ),
              ),
            )
          ],
