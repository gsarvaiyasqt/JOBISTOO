...
class PortfolioHomePaint extends StatefulWidget {
  PortfolioHomePaint({Key? key}) : super(key: key);

  @override
  _PortfolioHomePaintState createState() {
    return _PortfolioHomePaintState();
  }
}

class _PortfolioHomePaintState extends State<PortfolioHomePaint> {
