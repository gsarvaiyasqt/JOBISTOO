...
class JobberBusinessScreen extends StatefulWidget {
  const JobberBusinessScreen({super.key});

  @override
  State<JobberBusinessScreen> createState() => _JobberBusinessScreenState();
}

class _JobberBusinessScreenState extends State<JobberBusinessScreen> {
                      ...
                      child: Padding(
                        ...
                        child: ListView(
                          ...
                          children: [
                            Row(
                              children: [
                                Text("JOBISCO Name",style: CustomTextStyle.regularFont16Style,),
