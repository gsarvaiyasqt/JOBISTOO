...
class MyJobistoScreen extends StatefulWidget {
  const MyJobistoScreen({super.key});

  @override
  State<MyJobistoScreen> createState() => _MyJobistoScreenState();
}

class _MyJobistoScreenState extends State<MyJobistoScreen> {
